  ...
  render(){
    return (
      <form action="/" onSubmit={this.props.handleLogin} >
        <h2>Sign In</h2><br />
        <input type="email" name="login_email" onChange={this.props.handleInputChange} /><br />
        <input type="password" name="login_password" onChange={this.props.handleInputChange}/><br />
